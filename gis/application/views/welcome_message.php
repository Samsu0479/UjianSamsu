...
<?php } ?>
    <?php foreach ($map as $baris ) { ?>
       L.marker([<?php echo $baris->latitude;?>,<?php echo $baris->longitude;?>],{icon: <?php echo 'icon'.$baris->idkategori;?>}).addTo(map).bindPopup('<?php echo $baris->nama_lokasi;?> ,<br> <?php echo $baris->keterangan;?>');
   <?php  } ?>
